<template>
  <div id="proposals" class="main">
    <h2 class="h2" style="padding-top: 10px;">Предложения</h2>
    <div class="wrapper" style="margin-bottom: 40px">
      <img src="@/assets/proposals1.png" alt="" />
      <div>
        <h3 class="h3">Апартаменты</h3>
        <p class="text">
    ...
    <div class="wrapper">
      <div>
        <h3 class="h3">Пентхаусы</h3>
        <p class="text">
          На седьмом этаже Дома предусмотрено несколько пентхаусов. В
